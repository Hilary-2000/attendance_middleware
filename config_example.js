...
const config = Object.freeze({
  ...
  cloud: Object.freeze({
    ...
    attendanceEndpoint      : get    ("CLOUD_ATTENDANCE_ENDPOINT",        "/online_attendance.php"),
    staffAttendanceEndpoint : get    ("CLOUD_STAFF_ATTENDANCE_ENDPOINT", "/staff_attendance.php"),
    personSyncEndpoint      : get    ("CLOUD_PERSON_SYNC_ENDPOINT",       "/device_sync_persons.php"),
    personFlagEndpoint      : get    ("CLOUD_PERSON_FLAG_ENDPOINT",       "/device_sync_persons.php"),
